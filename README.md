...
- LL_Report_PartII
The PSSE file was generated using the GIS data procured by MIT-LL. 
THe final set of files in v30 format for four different architectures are provided. These files were presented in Chapter II of the monograph. 
...
Section 3.4. utilizes the file high HVGrid_v26.raw: This file consists only on the high voltage system and is used to perform robustness assessment with respect to voltage stability. 
